...
<template lang="">
  <div>
    ...
    <h1 class="text-2xl font-bold mb-4">Videos para {{ infoUser?.email }}</h1>
  ...
  <UInput class="w-5/6 text-sm font-medium text-gray-900 dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300" type="text" placeholder="Busca" v-model="searchValue" />
